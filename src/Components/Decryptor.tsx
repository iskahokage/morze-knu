...
const Decryptor: FC<decryptorProps> = ({ trigger }) => {
    ...
    const decodeFromMorse = () => {
        const morseMap: { [key: string]: string } = Object.fromEntries(
            ...
            <div className="grid gap-4">
                <div className="grid gap-4 grid-cols-2">
                    <button
                        ...
                        className="bg-gray-700 rounded-lg p-3 text-gray-50 hover:bg-gray-500 active:bg:gray-700 focus:bg-gray-600 disabled:bg-gray-400 outline-none"
                    >
                ...
                <div className="grid gap-4">
                    <h2 className="text-lg">Результат дешифрования:</h2>
